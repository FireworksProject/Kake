 ...
 */
exports.make_Settings = exports.makeSettings = (function (undef) {
return function Settings () {
    ...
    self.declare = function declare_setting(spec) {
        ...
        if (typeof key !== 'string') {
            err = new Error('typeof key ['+ spec.type +'] !== "string"');
        ...
        case 'boolean':
            break;
        default:
            err = new Error('Invalid setting type ['+ spec.type +'].');
            err.name = 'SettingDeclarationError';
            throw err;
        }
     ...
     * @throws {SettingDefineError} if the setting type is invalid or
     * unknown.
     */
