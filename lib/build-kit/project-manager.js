...
function make_Project(opts) {
    ...
    self.lock = function () {
        locked = true;
        return {tasks: get_tasks(), settings: JSON.parse(settings.all())};
    };
...
exports.Messenger = function Messenger(opts) {
    ...
    observe('open_file_picker', mailbox_decorator.observe(function (id, msg, data) {
        data = data || {};
    ...
    observe('open_folder_picker', mailbox_decorator.observe(function (id, msg, data) {
        data = data || {};
        data.window = tabs.activeTab.contentWindow;
